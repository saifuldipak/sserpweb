...
<template>
    ...
    <div v-if="props.viewName === 'Clients'">
        <input type="text" placeholder="Client name" v-model="formData.client.name" required />
        <select v-model="formData.client.client_type_id" required>
            <option disabled value="">client types</option>
            <option placeholder="client types" v-for="clientType in props.clientTypes" :value="clientType.id">{{ clientType.name }}</option>
        </select>
    </div>
    <div v-else-if="props.viewName === 'Services'">
        ...
        <select v-model="formData.service.service_type_id">
            ...
            <option placeholder="service type" v-for="serviceType in props.serviceTypes" :value="serviceType.id">{{ serviceType.name }}</option>
        </select>
    ...
    <div v-else-if="props.viewName === 'Vendors'">
        ...
        <select v-model="formData.vendor.type" required>
            ...
            <option placeholder="service type" v-for="vendorType in props.vendorTypes" :value="vendorType.type" :key="vendorType.id">
                {{ vendorType.type }}
            </option>
        </select>
    </div>
    ...
    <div v-else-if="props.viewName === 'Contacts'">
        ...
        <select v-model="formData.contact.type" required>
            ...
            <option placeholder="contact type" v-for="contactType in props.contactTypes" :value="contactType.type" :key="contactType.id">
                {{ contactType.type }}
            </option>
        </select>
    ...
    <div v-else-if="props.viewName === 'Client Types'">
        ...
        <input type="text" placeholder="Description (optional)" v-model="formData.clientTypes.description" />
    </div>
</template>
